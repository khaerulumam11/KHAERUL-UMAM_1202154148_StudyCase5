package com.example.khaerulumam.khaerulumam_1202154148_studycase5.database;
...
public class DataHelper extends SQLiteOpenHelper {
    ...
    static final String DATABASE_NAME = "umam.db";
    ...
    public ArrayList<HashMap<String, String>> getAllData() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                map.put(COLUMN_JUMLAH, cursor.getString(3));
                wordList.add(map);
    ...
    public void insert(String name, String address, String jumlah) {
        SQLiteDatabase database = this.getWritableDatabase();
        String queryValues = "INSERT INTO " + TABLE_SQLite + " (name, deskripsi,jumlah) " +
...
//
//    public void update(int id, String name, String address,String jumlah) {
//        SQLiteDatabase database = this.getWritableDatabase();
//
//        String updateQuery = "UPDATE " + TABLE_SQLite + " SET "
//                + COLUMN_NAME + "='" + name + "', "
//                + COLUMN_DESKRIPSI + "='" + address + "'"
